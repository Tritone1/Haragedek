  ...
  return <article className="ticket group overflow-hidden rounded-xl transition hover:-translate-y-1">
    <Link to={`/deals/${deal.id}`} className="block">
      <div className="relative h-44 overflow-hidden bg-primary-50 sm:h-48">
        {deal.restaurant.photoUrl ? <img src={deal.restaurant.photoUrl} alt="" className="h-full w-full object-cover transition duration-500 group-hover:scale-105" /> : <div className="map-grid h-full" />}
      ...
      <div className="px-5 pb-4 pt-4">
        ...
        <p className="mt-1 font-semibold">{deal.restaurant.name}</p>
